$PBExportHeader$vo_treelist.sru
forward
...
// 0 = supprimer l'entrée et pas Redessiner Supprimer 
// 1 = entrée et de redessiner 
// 2 = uniquement les entrées de l'enfant à supprimer et redessiner 
// Retourne 1 si l'entrée a été supprimée.

//Mais le message TVM_DELETEITEM est traité tel que :
...
lf.lfPitchAndFamily = char(1)
lf.lfClipPrecision = char(2)
lf.lfOutPrecision = char(1)
lf.lfQuality = char(1)

If ab_Italic Then lf.lfItalic = char(255)
If ab_UnderLine Then lf.lfUnderline = char(255)
If ab_StrikeOut Then lf.lfStrikeOut = char(255)
