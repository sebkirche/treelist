...
Function boolean ChooseFont ( &
	Ref CHOOSEFONT lpcf &
	) Library "comdlg32.dll" Alias For "ChooseFontA" 
...
li_Underline = Asc(lstr_LogFont.lfUnderline)
li_Italic = Asc(lstr_LogFont.lfItalic)
li_Strikeout = Asc(lstr_LogFont.lfStrikeout)

iUnderline = (li_Underline > 0)
iItalic = (li_Italic > 0)
iStrikeout = (li_Strikeout > 0)
